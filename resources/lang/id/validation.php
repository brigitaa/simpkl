...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'tanggal_mulai' => [
            'required' => 'Tanggal mulai periode PKL harus diisi.',
        ],

        'tanggal_selesai' => [
            'required' => 'Tanggal selesai periode PKL harus diisi.',
        ],

        'nama_dudi' => [
            'required' => 'Nama DU/DI harus diisi.',
            'unique' => 'Nama DU/DI ini sudah digunakan.',
        ],

        'alamat_dudi' => [
            'required' => 'Alamat DU/DI harus diisi.',
        ],
