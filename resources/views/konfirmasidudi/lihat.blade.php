...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-2">
            <form action="{{route('konfirmasidudi.lihat')}}" method="GET">
            ...
            <div class="col-1">
                    ...
                    <a class="btn btn-danger" href="{{route('konfirmasidudi.lihat')}}">Reset</a>
            </div>
            </form>
        </div>

        <div class="table-responsive">
            <table class="table table-bordered" id="konfirmasidudiTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>NIS</th>
...
@push('scripts')
<script>
    var table = $('#konfirmasidudiTable').DataTable({
        "scrollX": true,
        dom: '<lfB<t>ip>',
        "responsive": true,
        orderable: [
