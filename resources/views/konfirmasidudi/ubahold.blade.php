...
<div class="card shadow mb-4">
    ...
    <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="kelas" required value="{{$datasiswa->nama_kelas}}" readonly />
            </div>
        </div>
        <div class="form-group row">
            <label for="tahunajaran" class="col-sm-4 col-form-label">Tahun Ajaran<sup class="text-danger">*</sup></label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="tahunajaran" required value="{{$datasiswa->nama_thn_ajaran}}" readonly />
            </div>
        </div>
        <div class="form-group row">
            <label for="pengajuan" class="col-sm-4 col-form-label">ID Pengajuan PKL<sup class="text-danger">*</sup></label>
            <div class="col-sm-8">
                <select id="pengajuan" class="form-control" name="pengajuan_id" required>
