...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Ubah Data Tahun Ajaran</h6>
    </div>
    <div class="card-body">
    ...
    @csrf
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="kode_thn_ajaran" name="kode_thn_ajaran" 
                    required value="{{$tahunajaran->kode_thn_ajaran}}">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="nama_thn_ajaran" name="nama_thn_ajaran" 
                    required value="{{$tahunajaran->nama_thn_ajaran}}">
                <div class="text-danger">
